...
[RHC2 for Desktop](https://alpha.rhc2.revrobotics.com/download-site/download.html) - This can be used to install RHC2 to a connected Systemcore. After installing, you will be able to connect your local desktop client to the Systemcore's RHC2. Alternatively, access the Systemcore's RHC2 webpage from its homepage.

![rhc2 systemcore install](img/rhc2_systemcore_install.png)


Alternatively, the [RHC2 IPK for Systemcore](https://alpha.rhc2.revrobotics.com/download-site/debian/rev-robotics-rev-hardware-client-alpha_1.3.1_arm64.ipk) can be installed by clicking "Add Package" on the home screen of Systemcore and selecting this file.
...
- [A301 v2027.0.0-prerelease.16](https://github.com/REVrobotics/REV-Software-Binaries/releases/download/a301-27.0.0-prerelease.16/a301_27_0_0_prerelease_16.dfu) - please review warnings above before updating
